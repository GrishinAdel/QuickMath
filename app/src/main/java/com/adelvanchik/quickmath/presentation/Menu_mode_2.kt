    ...
    override fun onStart() {
        ...
        btn_starting_additionSimple?.setOnClickListener {
            if (levelAccess>=2) {
                ...
                (activity as MainActivity).navController.navigate(
                    R.id.action_menu_mode_2_to_starting,
                    bundle
                )
            }
        }
        ...
        vm.getLvlInfoLiveData().observe(viewLifecycleOwner, {
            ...
            if (it >=1) {
                ...
                btn_starting_multiplicationTableDivision?.setTextSize(
            ...
            if (it >=2) {
                ...
                btn_starting_additionSimple?.setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    resources.getDimension(R.dimen.button))
                levelAccess = 2
            }
            if (it >=3) {
                ...
                btn_starting_additionHundreds?.setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    resources.getDimension(R.dimen.button))
                levelAccess = 3
            }
            if (it >=4) {
                btn_starting_mixed?.setBackgroundColor(Color.parseColor(colorButton))
                btn_starting_mixed?.setText(R.string.mixed)
                btn_starting_mixed?.setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    resources.getDimension(R.dimen.button))
                levelAccess = 4
            }
            if (it >=5) {
                ...
                btn_starting_negative_multiplication?.setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    resources.getDimension(R.dimen.button))
                levelAccess = 5
            }
            if (it >=6) {
                ...
                btn_starting_negative_addition?.setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    resources.getDimension(R.dimen.button))
                levelAccess = 6
            }
            if (it >=7) {
                ...
                btn_starting_negative_mixed?.setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    resources.getDimension(R.dimen.button))
                levelAccess = 7
            }
